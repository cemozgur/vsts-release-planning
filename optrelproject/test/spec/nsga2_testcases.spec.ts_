...
//1
xdescribe("Test combinePopulations", () => {
...
//3
xdescribe("Test GA to make sure every feature is selected and defined", () => {
...
//6
xdescribe("Test GA dependency and every feature denpends on f1 ", () => {
...
//7
xdescribe("Test GA dependency and every feature denpends on f3 ", () => {
...
//8
xdescribe("Test GA to check the dependency of the algorithm", () => {
...
//10
xdescribe("Test GA dependency when two features depend on each other, it will throw error ", () => {
...
//12
xdescribe("Test features'selected ", () => {
...
//17
xdescribe("Test getObjectiveValueRange", () => {
