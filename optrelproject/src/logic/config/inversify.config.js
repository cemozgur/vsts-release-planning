...
var datasimulatortype_1 = require("../constants/datasimulatortype");
...
var MonteCarloSimulation_1 = require("../entities/MonteCarloSimulation");
...
container.bind(identifiers_1.default.IDataSimulator).to(MonteCarloSimulation_1.default).whenTargetNamed(datasimulatortype_1.default.Monte_Carlo);
